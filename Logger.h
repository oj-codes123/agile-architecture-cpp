...
#define LOG_DEBUG_S agile::Logger(true,__FILE__, __LINE__, __FUNCTION__, LogTrace).LogStream()
...
#define LOG_DEBUG_SN(logname) agile::Logger(true,logname, __FILE__, __LINE__, __FUNCTION__, LogTrace).LogStream()
...
#define LOG_DEBUG(format, ...) { agile::Logger(true,__FILE__, __LINE__, __FUNCTION__, LogTrace, format, ##__VA_ARGS__); }
...
#define LOG_DEBUG_N(logname, format, ...) { agile::Logger(true,logname, __FILE__, __LINE__, __FUNCTION__, LogTrace, format, ##__VA_ARGS__); }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
#define LOG_DEBUG_S_QUICK agile::Logger(false,__FILE__, __LINE__, __FUNCTION__, LogTrace).LogStream()
...
#define LOG_DEBUG_SN_QUICK(logname) agile::Logger(false,logname, __FILE__, __LINE__, __FUNCTION__, LogTrace).LogStream()
...
#define LOG_DEBUG_QUICK(format, ...) { agile::Logger(false,__FILE__, __LINE__, __FUNCTION__, LogTrace, format, ##__VA_ARGS__); }
...
#define LOG_DEBUG_N_QUICK(logname, format, ...) { agile::Logger(false,logname, __FILE__, __LINE__, __FUNCTION__, LogTrace, format, ##__VA_ARGS__); }
